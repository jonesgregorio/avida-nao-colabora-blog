...
- **Plano de autocuidado** usa o mês-calendário encerrado, exige pelo menos 12 registros de acompanhamento distribuídos em 8 dias ativos; a base inclui check-ins, Diário, questionários, conteúdos sugeridos/vistos, conteúdos guiados/personalizados e outros sinais estruturados úteis e transforma a análise automática em pequenos passos. Quando elegível, passa por revisão humana e deve ser liberado até o dia 5 do mês seguinte; sem atividade suficiente, nenhum plano genérico é criado e o usuário vê o motivo na própria página.
