  ...
  return <main className="min-h-full bg-[#f7f0e5] text-forest-950">
    <section className="relative overflow-hidden border-b border-[#ded3c3] bg-[#efe4d4]">
      ...
      <div className="relative z-10 mx-auto min-h-[760px] max-w-[1240px] px-5 py-10 sm:px-8 lg:min-h-[820px] lg:px-10 lg:py-12">
        <div className="max-w-[520px] rounded-[30px] border border-white/35 bg-[#fffaf1]/[0.72] p-7 shadow-[0_24px_80px_rgba(47,62,43,.12)] backdrop-blur-sm sm:p-9">
        ...
        <div className="absolute right-5 top-10 hidden w-[330px] rounded-[28px] border border-white/65 bg-[#fffdf8]/[0.88] p-6 shadow-[0_24px_70px_rgba(41,60,45,.14)] backdrop-blur-md md:block lg:right-10">
        ...
        <div className="absolute bottom-8 left-5 right-5 lg:left-auto lg:right-10 lg:w-[500px]">
          <section className="rounded-[30px] border border-white/70 bg-[#fffdf9]/[0.94] p-6 shadow-[0_28px_80px_rgba(35,52,38,.18)] backdrop-blur-md sm:p-7">
