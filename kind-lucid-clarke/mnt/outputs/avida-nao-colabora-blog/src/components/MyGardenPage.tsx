...
import { Bird, ChevronLeft, ChevronRight, LockKeyhole, Sparkles, Sprout, Waves } from 'lucide-react'
...
export default function MyGardenPage({userId,profile,onNavigatePricing}:Props){
  ...
  <p className="sr-only">Seu jardim evolui aos poucos conforme você registra momentos de cuidado. Se você passar alguns dias longe, nada será perdido.</p></div>
}
