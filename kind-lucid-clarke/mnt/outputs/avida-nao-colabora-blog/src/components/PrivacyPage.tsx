      ...
      <div className="prose-sm text-sage-600 space-y-8">
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed mt-3">
            No Plano Terapêutico Plus, o profissional parceiro pode ter acesso ao seu relatório mensal para a sessão individual — somente com sua autorização explícita.
          </p>
        </section>
