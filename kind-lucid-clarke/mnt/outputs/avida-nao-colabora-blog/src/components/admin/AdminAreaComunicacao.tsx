...
// Abas de Comunicação: Notificações / E-mails enviados / Templates de e-mail.
// (A antiga "Campanhas" / Conteúdos Automáticos foi removida — substituída pela
//  Fábrica IA + Automações, que geram/agendam conteúdo do blog.)
const TABS = [
  ...
  return (
    <div className="flex flex-col min-h-0">
      <div className="px-6 pt-8 pb-4 max-w-7xl mx-auto w-full">
        ...
        <p className="text-sm text-ink-soft mt-1">Envie notificações, acompanhe e-mails e gerencie templates.</p>
      </div>
