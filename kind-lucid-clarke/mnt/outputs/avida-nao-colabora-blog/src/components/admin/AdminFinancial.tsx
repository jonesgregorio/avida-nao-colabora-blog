...
export default function AdminFinancial() {
  ...
  return (
    <div>
      ...
      <p className="text-stone-400 text-sm mb-6">Receita estimada com base nos planos ativos dos usuários.</p>
            ...
            <tbody>
              {stats.planStats.map(ps => (
                <tr key={ps.plan} className="border-b border-stone-50 hover:bg-stone-50">
                  ...
                  <td className="py-2.5 text-right text-stone-500">{fmt(PLAN_PRICES[ps.plan] ?? 0)}</td>
