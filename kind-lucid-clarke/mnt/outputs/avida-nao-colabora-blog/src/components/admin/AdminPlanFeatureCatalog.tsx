        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/45 p-4" role="dialog" aria-modal="true" aria-label={isNew ? 'Nova funcionalidade' : 'Editar funcionalidade'}>
          <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
            ...
            <div className="space-y-6 p-5">
              ...
              <section><h4 className="text-sm font-semibold text-forest-900">Texto por plano</h4><p className="mt-1 text-xs text-ink-soft">Deixe o texto específico vazio para usar o nome e a descrição gerais. Para recursos do sistema, o "Nome específico" também é o texto/símbolo exibido nesta coluna na tabela "Compare todos os recursos" (Pricing e Meu Plano) — ex.: "Até 5 dias/mês". A disponibilidade técnica continua sendo controlada na tela de permissões.</p><div className="mt-3 space-y-3">{PLAN_KEYS.map(plan => {
