...
const REPLY_TEMPLATES_FALLBACK = [
  ...
  { id: 'f05', title: 'Diferença entre os planos', category: 'Planos', body: 'Olá! Os planos foram pensados para diferentes níveis de uso dentro do site.\n\nO Gratuito permite começar: Check-in diário, Diário emocional em até 5 dias por mês, Diário por voz, uma seleção de questionários, conteúdos guiados e uma visão inicial da Minha História.\n\nO Essencial ({{preco_essential}}/mês) amplia o acompanhamento: Diário sem limite mensal, Mapa Emocional, Descobertas, Minha História completa, Relatório Semanal, Meu Jardim e conteúdos guiados completos.\n\nO Plus ({{preco_plus}}/mês) inclui tudo do Essencial e acrescenta Aprofundamentos do Diário, Relatório Mensal Aprofundado, Plano de Autocuidado Mensal e Orientação Mensal.' },
  { id: 'f06', title: 'Plano Gratuito', category: 'Planos', body: 'O plano Gratuito é uma forma de começar a usar o site sem compromisso.\n\nEle inclui artigos gratuitos, uma seleção de questionários, Check-in diário (1 por dia), Diário emocional com até 5 dias com registros por mês, Diário por voz, uma seleção de Conteúdos Guiados e uma visão inicial da Minha História.\n\nÉ ideal para conhecer o projeto e começar a registrar emoções de forma simples.' },
  { id: 'f07', title: 'Plano Essencial', category: 'Planos', body: 'O plano Essencial custa {{preco_essential}} por mês e é indicado para quem quer usar o site de forma contínua.\n\nEle inclui tudo do Gratuito e também Diário emocional sem limite mensal, Mapa Emocional completo, Descobertas, Minha História completa, Conteúdos Guiados completos, Relatório Semanal automático e Meu Jardim.' },
  { id: 'f08', title: 'Plano Plus', category: 'Planos', body: 'O plano Plus custa {{preco_plus}} por mês e é o plano mais completo.\n\nEle inclui tudo do Essencial e também Aprofundamentos do Diário (até 3 por dia), Relatório Mensal Aprofundado, Plano de Autocuidado Mensal e Orientação Mensal por mensagem.' },
  { id: 'f10', title: 'Qual plano escolher', category: 'Planos', body: 'Para escolher o plano, pense no tipo de uso que você deseja.\n\nSe você quer apenas conhecer o site, o Gratuito pode ser suficiente.\nSe quer registrar emoções com frequência e acompanhar seu Mapa Emocional e Descobertas, o Essencial costuma fazer mais sentido.\nSe quer também Aprofundamentos do Diário, Plano de Autocuidado Mensal, relatório aprofundado e Orientação Mensal, o Plus é o plano mais completo.' },
  ...
  { id: 'f13', title: 'Comentário sobre o relatório do mês', category: 'Profissional', body: 'O comentário individual de um profissional sobre o relatório mensal foi descontinuado e não é mais gerado para novos relatórios.\n\nComentários enviados no passado continuam disponíveis para o usuário consultar. Para apoio contínuo dentro do plano Plus, a Orientação Mensal por mensagem continua ativa.' },
