...
export const TASK_DEFS: TaskDef[] = [
  ...
  {
    key: 'mini_challenge',
    title: 'Pequena prática guiada quinzenal',
    description: 'Uma prática breve de autoconhecimento a cada 15 dias.',
    contentType: 'mini_challenge',
    targetArea: 'resumo',
    notificationTitle: 'Nova prática guiada disponível',
    notificationBody: 'Sua pequena prática guiada quinzenal está pronta.',
    frequency: 'biweekly',
    minPlan: 'free',
    priority: 'low',
  ...
  // ── Essencial ──
  {
    ...
    title: 'Pausa emocional guiada',
    description: 'Uma pausa em texto para ajudar você a se reconectar com o momento.',
    contentType: 'guided_meditation',
    targetArea: 'meditations',
    notificationTitle: 'Pausa emocional disponível',
    notificationBody: 'Sua pausa emocional guiada da semana está pronta.',
    frequency: 'weekly',
    minPlan: 'essential',
    priority: 'low',
    dueType: 'end_of_week',
  ...
  // ── Plus (personalização) ──
  {
    ...
    title: 'Prática guiada da semana',
    description: 'Sequência leve de cuidado para a semana.',
    contentType: 'weekly_self_care',
    targetArea: 'self_care_plan',
    notificationTitle: 'Sua prática guiada está pronta',
    notificationBody: 'Sua sequência leve de cuidado está disponível.',
    frequency: 'weekly',
    minPlan: 'plus',
    priority: 'medium',
    dueType: 'start_of_next_week',
  ...
  },
  {
    ...
    title: 'Reflexão mensal guiada',
    description: 'Uma reflexão guiada sobre o mês, separada do relatório mensal aprofundado.',
    contentType: 'advanced_monthly_report',
    targetArea: 'reports',
    notificationTitle: 'Reflexão mensal disponível',
    notificationBody: 'Sua reflexão mensal guiada está disponível.',
    frequency: 'monthly',
    minPlan: 'plus',
    priority: 'medium',
    dueType: 'day_of_month',
...
export const PERSONALIZED_CONTENT_LABELS: Record<string, string> = {
  ...
  mini_challenge: 'Exercício guiado',
  diary_question: 'Pergunta para o diário',
  guided_meditation: 'Pausa emocional',
  emotional_exercise: 'Exercício emocional',
  monthly_summary: 'Resumo mensal simples',
  advanced_report: 'Relatório avançado',
  advanced_monthly_report: 'Reflexão mensal guiada',
  weekly_self_care: 'Prática guiada da semana',
  self_care_plan: 'Plano de autocuidado',
  ...
  session_themes: 'Sugestões para orientação',
  session_summary: 'Resumo do acompanhamento',
  post_session_message: 'Mensagem de orientação',
  ...
  weekly_report_suggestion: 'Destaques da semana',
