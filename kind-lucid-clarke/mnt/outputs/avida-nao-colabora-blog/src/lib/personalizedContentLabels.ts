...
export const TARGET_AREA_LABELS: Record<string, string> = {
  ...
  orientacoes: 'Orientação profissional',
  professional_comments: 'Comentário profissional',
  session_plus: 'Orientação por mensagem',
  sessions: 'Orientação por mensagem',
...
export const TARGET_AREA_TO_USER_TAB: Record<string, string> = {
  ...
  session_plus: 'orientacoes',
  sessions: 'orientacoes',
  reports: 'relatorios',
