...
export const SEO_PILLAR_GUIDES: SeoGuide[] = [
  ...
  { title:'Relações e limites', slug:'como-conversar-sobre-os-seus-limites-sem-transformar-tudo-em', description:'Perceba quando um limite precisa ser colocado e aprenda a comunicá-lo com clareza, respeito e menos necessidade de se justificar.', cluster:'Relações e limites', searchIntent:'Como perceber e colocar limites nas relações', accent:'Perceber, comunicar e sustentar', relatedTerms:['como colocar limites','quando colocar limites','limites pessoais','comunicação de limites','relações'], tool:'diary', supportingSlugs:['como-perceber-quando-um-limite-precisa-ser-colocado'] },
]
