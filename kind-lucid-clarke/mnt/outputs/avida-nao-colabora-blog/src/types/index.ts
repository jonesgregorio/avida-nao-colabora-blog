...
export type View = 'home' | 'auth' | 'article' | 'diary' | 'profile' | 'meditations' | 'challenges' | 'content' | 'therapeutic-q' | 'about' | 'privacy' | 'terms' | 'questionnaire' | 'questionarios' | 'questionarios-evolucao' | 'pricing' | 'articles' | 'guides' | 'editorial-policy' | 'responsibility' | 'trails' | 'saved' | 'admin' | 'contact' | 'success' | 'newsletter-unsubscribed' | 'support' | 'support-ticket' | 'notifications' | 'monthly-guidance' | 'professional-comments' | 'my-plan' | 'my-report' | 'my-evolution' | 'my-history' | 'my-garden' | 'self-care' | 'descobertas' | 'cuidar' | 'mais' | 'conquistas' | 'lembretes' | 'faq'
