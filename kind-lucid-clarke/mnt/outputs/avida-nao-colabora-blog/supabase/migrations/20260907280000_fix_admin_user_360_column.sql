-- Hotfix Etapa 1 — admin_user_360 referenciava user_subscriptions.stripe_subscription_id,
-- mas a coluna real é provider_subscription_id. Isso fazia a função falhar com
-- 'column does not exist' e a gaveta 360 mostrava 'ainda não publicada'.
-- Recria a função idêntica, só corrigindo a coluna. Idempotente.
