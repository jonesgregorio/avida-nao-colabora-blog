...
(
 ...
 '[
   ...
   {"id":"q2","type":"single","required":true,"text":"Com que frequência você se sente cansado(a) de forma que o descanso não resolve?","options":[
   ...
   {"id":"q4","type":"single","required":true,"text":"Você tem se sentido sobrecarregado(a)?","options":[
   ...
   {"id":"q6","type":"single","required":true,"text":"Como está o seu sono?","options":[
     ...
     {"id":"o4","text":"Acordo exausto(a)","score":3}]},
...
(
 ...
 '[
   ...
   {"id":"q4","type":"single","required":true,"text":"Você sente uma sensação de urgência constante?","options":[
     {"id":"o1","text":"Raramente","score":0},{"id":"o2","text":"Às vezes","score":1},{"id":"o3","text":"Com frequência","score":2},{"id":"o4","text":"Quase sempre","score":3}]},
   {"id":"q5","type":"single","required":true,"text":"Você tem se sentido irritado(a)?","options":[
     {"id":"o1","text":"Raramente","score":0},{"id":"o2","text":"Às vezes","score":1},{"id":"o3","text":"Com frequência","score":2},{"id":"o4","text":"Quase sempre","score":3}]},
...
(
 ...
 '[
   ...
   {"id":"q2","type":"single","required":true,"text":"Você acorda cansado(a)?","options":[
     {"id":"o1","text":"Raramente","score":0},{"id":"o2","text":"Às vezes","score":1},{"id":"o3","text":"Com frequência","score":2},{"id":"o4","text":"Quase sempre","score":3}]},
...
(
 ...
 '[
   {"id":"r1","min_score":0,"max_score":20,"label":"Seu mapa do mês está pronto","color":"#1A4A3A",
    "description":"Obrigada por compartilhar. Suas respostas vão compor o seu plano de autocuidado mensal.",
...
(
 ...
 '[
   ...
   {"id":"q4","type":"single","required":true,"text":"Onde os conflitos pesam mais?","options":[
     {"id":"o1","text":"Família","score":1,"tag":"familia"},{"id":"o2","text":"Trabalho","score":1,"tag":"trabalho"},{"id":"o3","text":"Relacionamento","score":1,"tag":"relacionamento"},{"id":"o4","text":"Comigo mesmo(a)","score":1,"tag":"eu"}]},
...
(
 ...
 '[
   {"id":"r1","min_score":0,"max_score":20,"label":"Sua jornada, revisada","color":"#1A4A3A",
    "description":"Obrigada por olhar para o seu percurso. Isso ajuda a definir os próximos passos com mais clareza.",
