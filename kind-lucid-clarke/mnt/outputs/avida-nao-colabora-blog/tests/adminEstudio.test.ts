...
test('Estúdio Social permanece registrado como área própria',()=>{
 ...
 assert.match(layout,/id: 'estudio', label: 'Estúdio Social'/)
})
test('o Estúdio traz as sete abas do mockup',()=>{for(const id of ['novo','calendario','grade','destaques','inspiracao','comunidade','desempenho'])assert.match(estudio,new RegExp(`id: '${id}'`))})
