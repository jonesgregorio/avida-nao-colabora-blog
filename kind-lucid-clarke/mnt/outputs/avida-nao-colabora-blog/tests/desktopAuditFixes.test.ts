...
test('Meu Jardim traz explicação editorial simples no lugar',()=>{assert.match(garden,/Seu jardim cresce sem pressa/);assert.match(garden,/nada aqui murcha se você precisar se afastar/);assert.match(garden,/Ele não cresce por um gesto isolado/)})
