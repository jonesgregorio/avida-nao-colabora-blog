...
test('OFFICIAL_FEATURE_KEYS da Edge Function fica em sincronia com os 13 recursos técnicos oficiais', () => {
  ...
  assert.equal(officialFeatureKeys.length, 13, 'auditoria assume 13 recursos técnicos oficiais — atualize a Edge Function se isso mudar')
